  ...
  if (!data) {
    return (
      <div className="text-center p-12 text-neutral-500 font-mono">
        No infographic data available. Generate content to view infographic.
      </div>
    );
  }
  ...
  return (
    <div className="p-12 bg-white dark:bg-neutral-800 rounded-[3rem] shadow-2xl border border-neutral-100 dark:border-neutral-700 max-w-4xl mx-auto space-y-16">
      <div className="text-center">
        <h1 className="text-5xl font-black text-neutral-900 dark:text-neutral-50 mb-6 uppercase tracking-tighter">{data.title || 'Infographic'}</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {data.stats.map((stat, idx) => (
            <div key={idx} className="bg-neutral-50 dark:bg-neutral-700 p-10 rounded-[2rem] border border-neutral-100 dark:border-neutral-600 text-center transition-transform hover:-translate-y-1">
              ...
              <p className="text-4xl font-black text-neutral-950 dark:text-neutral-50">{stat.value || '0'}</p>
              {stat.trend && (
                <div className="mt-3">
